...
# FOR ACCRE SYSTEM ----------------------------- INTEGRATION
    ...
    async def accre_pagination(user_type: str):
        ...
        if user_type == "student":
            return await ResearchPaperRepository.accre_get_student()
        else:
            return {"ERROR: Please specify"}
                
    
    
    @staticmethod
    async def accre_combine():
        faculty_papers = await ResearchPaperRepository.accre_get_faculty()
        student_papers = await ResearchPaperRepository.accre_get_student()
    ...
    # @staticmethod
    # async def accre_get_student_papers_by_course(user_type: str, type_paper: str):
    #         research_paper_query = (
    #             select(
    #                 ResearchPaper.id,
    #                 ResearchPaper.title,
